...
const Footballwar = () => {
    return (
        ...
        <>
            ...
            <Helmet>
                <title>Football War 3: When AI Coaches Go Head-to-Head | Fyrexia AI Tools</title>
                <meta
                    name="description"
                    content="Explore the emerging dominance of AI in football coaching — where data, strategy, and real-time insights elevate the game like never before."
                />
                <meta
                    name="keywords"
                    content="AI football coaches, football strategy, data analytics, AI in sports, match tactics, Fyrexia"
                />
                <meta name="author" content="Fyrexia AI Tools" />

                {/* Open Graph */}
                <meta property="og:title" content="Football War 3: When AI Coaches Go Head-to-Head" />
                <meta
                    property="og:description"
                    content="Discover how artificial intelligence is transforming football strategy — where AI coaches compete with human intuition on the field."
                />
                <meta property="og:type" content="article" />
                <meta property="og:url" content="https://fyrexia.co.uk/football-war3-ai-coaches" />
                <meta
                    property="og:image"
                    content="https://i.postimg.cc/pTqt5wLW/freepik-the-style-is-candid-image-photography-with-natural-64776.png"
                />
                <link rel="canonical" href="https://fyrexia.co.uk/football-war3-ai-coaches" />
            </Helmet>
